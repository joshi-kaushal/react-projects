...
const Sidebar = () => {
  ...
  return <div className={` ${isMenuOpen ? 'visible transform scale-1 z-2 ' : 'hidden transform scale-0 -z-1'} fixed place-items-center top-0 left-0 grid w-full h-full transition duration-300 ease-in `}>
    {/* sidebar */}
